          ...
          <div class="card justify-content-center">
            ...
            <!-- <p class="card-text lh-base"> الفرع : ${employee.branch}</p> -->
                 ...
                 <div class="card-footer ">
                   <button type="button" class="btn btn-secondary btn-sm justify-content-center "  data-bs-target="#selectedRowModal">عرض التفاصيل</button>
                 </div>
            </div>
        `;
